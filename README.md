...
### 5. 🔍 Интеграция с Uzum Market: Поиск и просмотр карточки с фото
Для предотвращения пересорта и визуальной сверки оператор может в 1 клик нажать **`🔍 Товар на Uzum`**:
- **Модальное окно карточки товара:** Мгновенно отображает оригинальные фотографии товара с маркетплейса Uzum;
- **Галерея ракурсов:** Просмотр внешнего вида, фирменной коробки и комплектации;
- **Технические параметры:** Точный цвет, тип упаковки, наименование продавца (Merchant) и адрес ячейки размещения;
- **Прямой переход:** Кнопка **«🍇 Открыть на Uzum Market»** для быстрого перехода на сайт маркетплейса по артикулу.

![Просмотр фото товара на Uzum Market](docs/screenshots/05_uzum_search_photo_modal.png)
